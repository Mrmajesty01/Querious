...
public class MessageViewHolder extends RecyclerView.ViewHolder {
    ...
    TextView sendertv,receivertv,playsend,playreceive;
    ...
    public void Setmessage(Application application ,  String message, String time, String date,String type,
        ...
        playsend = itemView.findViewById(R.id.audio_sender);
        playreceive = itemView.findViewById(R.id.audio_receiver);
