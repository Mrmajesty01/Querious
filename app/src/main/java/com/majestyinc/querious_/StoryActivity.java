...
public class StoryActivity extends AppCompatActivity {
    ...
    DocumentReference documentReference,userStory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        documentReference = fr.collection("user").document(currenUid);

        storageReference =firebaseStorage.getInstance().getReference("story");

        userStory = db.collection("story").document(currenUid);

        Allstory = database.getReference("All story");
        userstory = database.getReference("story").child(currenUid);

        dr2 = fr.collection("All story").document();
        dr1 = fr.collection("story").document(currenUid);
        ...
        userStory.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
